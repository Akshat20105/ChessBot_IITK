...
namespace Chess.Game {
	public class GameManager : MonoBehaviour {
		...
		public void NewGame (bool humanPlaysWhite) {
			...
			whiteClock.secondsRemaining = whiteClock.startSeconds;
			blackClock.secondsRemaining = blackClock.startSeconds;
		}
		...
		void LogAIDiagnostics () {
			...
			var d = aiSettings.diagnostics;
			//text += "AI Diagnostics";
			text += $"<color=#{"009FFF"}>Akshara_ChessBot\n";
		...
		Result GetGameState () {
			...
			move_d += aiSettings.diagnostics.moveVal+" ";
